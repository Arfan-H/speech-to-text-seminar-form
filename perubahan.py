...
class Mainclass:
    ...
    def loginPage(self):
        ...
        self.tombol = Button(self.mainframe, width=19, pady=7, text='Get Started', bg='red', fg='white', border=0,font=('Poppins', 14),cursor='hand2',activebackground='#004AAD',command=self.signin).place(x=531, y=483)
    ...
    def mainPage(self):
        ...
        self.teks = Text(self.third_frame,border=0, height=29, width=90, wrap="word", font=('Montserrat', 12,'bold'), bg='#a2272c', fg='white')
    ...
    def saveFile(self):
        if self.namaFile.get() == 0 or self.namaFile.get() == 'Masukkan Nama File':
            ...
            filename = f'database\{self.namaFile.get()}.txt'
